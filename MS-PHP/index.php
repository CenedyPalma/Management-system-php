...
<body>
  <div class="navigation-bar">
    ...
    <div class='dropdown-content'>
      ...
      <a href='supervisor.login.php'>Doctor login</a>
      <a href='index1.php'>Supervisor Login</a>
      <a href='staff.login.php'>Nurse Login</a>
    </div>
  </div>
 <a href='index.php'> Home</a>";
    }
  ...
  <div class="intro">
    <img src="Resource/B.jpeg">
    <div class="intro_write">
      <h1 class="intro_head"> Record Management System</h1><br>
